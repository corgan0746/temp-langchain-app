...
class LLMInputOutputAdapter:
    ...
    def prepare_input(
        ...
        if provider == "anthropic" or provider == "ai21":
            ...
            input_body = dict()
            # changed the body property name to prompt
            input_body["prompt"] = prompt
    ...
    def _call(
     ...
     "body": body
        ...
        try:
            ...
            # )
            response = self.client.invoke_model(**bedrock_params)
            resp_json = json.loads(response.get('body').read())
            print("resp_json:")
            print(resp_json)
            text = LLMInputOutputAdapter.prepare_output(provider, resp_json)
